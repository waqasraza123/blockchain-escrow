...
export const enMessages = {
  ...
  wallets: {
    ...
    switchChainFailed: "Wallet chain switch failed.",
    trackingPending: "The transaction hash was recorded and is now pending reconciliation.",
    title: "Wallet convenience",
    updatePolicy: "Update policy",
    userRejected: "Wallet signature or submission was rejected.",
    wallet: "Wallet",
...
export const arMessages = {
  ...
  wallets: {
    ...
    executionChain: "السلسلة",
    executionMethod: "الطريقة",
    expires: "ينتهي",
    ...
    switchChainFailed: "فشل تبديل سلسلة المحفظة.",
    trackingPending: "تم تسجيل تجزئة المعاملة وهي الآن بانتظار التسوية.",
    title: "راحة المحفظة",
    updatePolicy: "تحديث السياسة",
    userRejected: "تم رفض توقيع المحفظة أو إرسال المعاملة.",
    wallet: "المحفظة",
